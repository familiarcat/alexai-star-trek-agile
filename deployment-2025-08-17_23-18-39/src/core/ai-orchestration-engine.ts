    ...
    const agents: AIAgent[] = [
      {
        ...
        expertise: ['strategic_planning', 'decision_making', 'goal_alignment', 'leadership'],
      ...
      {
        id: 'commander_data',
        name: 'Lieutenant Commander Data (Operations)',
        role: 'Efficiency & Performance Analyst',
        expertise: ['performance_optimization', 'data_analysis', 'system_efficiency', 'type_safety'],
        currentContext: this.getDefaultContext(),
        isActive: true,
        lastActivity: new Date(),
        performanceMetrics: this.getDefaultPerformanceMetrics()
      ...
      {
        id: 'counselor_troi',
        name: 'Counselor Deanna Troi (UI/UX)',
        role: 'User Experience & Emotional Design',
        expertise: ['user_experience', 'emotional_design', 'accessibility', 'team_morale'],
        currentContext: this.getDefaultContext(),
        isActive: true,
        lastActivity: new Date(),
        performanceMetrics: this.getDefaultPerformanceMetrics()
      ...
      {
        id: 'chief_engineer_scott',
        name: 'Chief Engineer Montgomery Scott (Infrastructure)',
        role: 'Infrastructure & Build Systems',
        expertise: ['infrastructure', 'deployment', 'technical_implementation', 'build_systems'],
        currentContext: this.getDefaultContext(),
        isActive: true,
        lastActivity: new Date(),
        performanceMetrics: this.getDefaultPerformanceMetrics()
      },
      {
        ...
        role: 'Logic & Time Management',
        expertise: ['logical_analysis', 'time_management', 'efficiency', 'risk_assessment'],
        currentContext: this.getDefaultContext(),
        isActive: true,
        lastActivity: new Date(),
        performanceMetrics: this.getDefaultPerformanceMetrics()
      },
      {
        ...
        expertise: ['security_protocols', 'compliance', 'risk_management', 'defense'],
        currentContext: this.getDefaultContext(),
        isActive: true,
        lastActivity: new Date(),
        performanceMetrics: this.getDefaultPerformanceMetrics()
      },
      {
        ...
        role: 'Revenue & Business Intelligence',
        expertise: ['business_intelligence', 'revenue_optimization', 'market_analysis', 'profitability'],
        currentContext: this.getDefaultContext(),
        isActive: true,
        lastActivity: new Date(),
        performanceMetrics: this.getDefaultPerformanceMetrics()
      },
      {
        ...
        name: 'Observation Lounge (Collective Intelligence)',
        role: 'Crew Coordination & Collective Decision Making',
        expertise: ['crew_coordination', 'collective_intelligence', 'consensus_building', 'team_synergy'],
        currentContext: this.getDefaultContext(),
        isActive: true,
        lastActivity: new Date(),
        performanceMetrics: this.getDefaultPerformanceMetrics()
