...
from src.core.agile_project_manager import AgileProjectManager, Project, Task, TaskStatus, Priority, ProjectType
from src.core.alexai_core_agent import alexai_core, AlexAIMode

# Get the absolute path to the project root
project_root = Path(__file__).parent.parent.parent
template_folder = project_root / "frontend" / "web" / "templates"
static_folder = project_root / "frontend" / "web" / "static"
