...
interface MainDashboardDesktopProps {
  className?: string;
  children?: React.ReactNode;
}

export const MainDashboardDesktop: React.FC<MainDashboardDesktopProps> = ({ 
  className = '', 
  children 
}) => {
  ...
  return (
    <div 
      className={`maindashboarddesktop ${className}`}
      style={{
        width: '100%',
        height: '100%',
